...
public class IntHashMap implements Cloneable {
    ...
    private static class Entry implements Cloneable {
        ...
        /**
         * Make a cloned copy of this class. Implementation makes a shallow copy
         * of all data except the next pointer, which it will automatically
         * clone (ie deep clone of next).
         * 
    ...
    /**
     * Make a cloned copy of this class. Implementation makes a shallow clone of
     * the internal structures only. All data contained within the object are
     * not cloned.
     * 
     * @return A cloned instance of this instance
     * @throws CloneNotSupportedException Something lower couldn't clone
