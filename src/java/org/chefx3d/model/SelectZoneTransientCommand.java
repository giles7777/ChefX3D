 ...
 */
public class SelectZoneTransientCommand implements Command {
     ...
     */
    public SelectZoneTransientCommand(
    ...
    public SelectZoneTransientCommand(LocationEntity locationEntity) {
        this.locationEntity = locationEntity;
    }
