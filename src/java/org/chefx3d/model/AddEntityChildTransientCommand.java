 ...
 */
public class AddEntityChildTransientCommand implements Command, RuleDataAccessor {
     ...
     */
    public AddEntityChildTransientCommand(WorldModel model, Entity parent, Entity child) {
	...
	public boolean isEqualTo(Command externalCommand) {
		...
		if (externalCommand instanceof AddEntityChildTransientCommand) {
