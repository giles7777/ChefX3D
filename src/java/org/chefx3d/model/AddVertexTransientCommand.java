 ...
 */
public class AddVertexTransientCommand implements Command, RuleDataAccessor {
     ...
     */
    public AddVertexTransientCommand(
     ...
     */
    public AddVertexTransientCommand(int entityId) {
        // Cast to package definition to access protected methods
        //this.entity = entity;        
	...
	public boolean isEqualTo(Command externalCommand) {
		...
		if (externalCommand instanceof AddVertexTransientCommand) {
			
			if (((AddVertexTransientCommand)externalCommand).getEntity() != 
				vertex) {
				
				return false;
				
			} else if (((AddVertexTransientCommand)externalCommand).
