 ...
 */
public class MultiCommand implements Command, RuleBypassFlag, RuleDataAccessor {
     ...
     */
    public MultiCommand(ArrayList<Command> commandList, String description, boolean isUndoable) {
     ...
     * @param description - The description to display
     */
    public MultiCommand(ArrayList<Command> commandList, String description) {
    ...
    public MultiCommand(
    	...
    	this (commandList, description, isUndoable, ruleBypassFlag);
    ...
    public boolean isEqualTo(Command externalCommand) {
        ...
        if (externalCommand instanceof MultiCommand) {

            ArrayList<Command> externalCmdList =
                ((MultiCommand)externalCommand).getCommandList();
