...
public class VertexTreeNode implements MutableTreeNode {
     ...
     *
     * @param entity The entity this tree node represents
     * @param vertexID The vertexID this tree node represents
    ...
    public VertexTreeNode(Entity entity, int vertexID, MutableTreeNode parent) {
        ...
        vertexMap = new HashMap<Integer, VertexTreeNode>();
    ...
    VertexTreeNode getTreeNodeChild(int child) {
        return (VertexTreeNode) vertexMap.get(child);
    }
