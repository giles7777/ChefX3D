...
/**
 * Responds to DefaultEntity Rotation events. This is only for
 * non-transient move events. The appropriate command is issued for the event.
 *
 * @author Jonathon Hubbard, Ben Yarger
 * @author Eric Fickenscher version 1.3
 * @version $Revision: 1.13 $
 *
 */
public class DefaultEntityRotationResponse implements
     ...
     */
    public DefaultEntityRotationResponse(
