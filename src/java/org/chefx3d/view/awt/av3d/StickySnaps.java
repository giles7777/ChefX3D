...
/**
 * This class manages the StickySnap lines overlay
 *
 * @author Eric Fickenscher
 * @version $Revision: 1.4 $
 */
public class StickySnaps extends OverlayComponent {

    /** Default diffuse color for the line (black) */
    private static final Color DEFAULT_LINE_COLOR = Color.black;

    /** transparency to use for the dimensional guides */
    private static final float TRANSPARENCY = 1f;

    /** The screen values (of overlay layer) of the
     * start and end snap points. */
    private float[] snap_vertices;

	/** Grid line geometry */
	private LineArray line_geom;
	
    /**
     * Create a new instance of the StickySnaps class
     *
     */
    public StickySnaps(SceneManagerObserver mgmtObserverParam,
    ...
    public void updateNodeBoundsChanges(Object src) {
        ...
        if ( src == line_geom ) {
        	...
        	line_geom.setVertices(LineArray.COORDINATE_3, snap_vertices);
        }
    }
     ...
     */
    public void drawStickySnaps(float[] f){
	...
	private void initSceneGraph() {
		...
		snap_vertices = new float[]{ 0, 0, -.001f, 0, 0, -.001f};
        line_geom.setVertices(LineArray.COORDINATE_3, snap_vertices);
