 ...
 */
public class SegmentEntityScaleResponse implements
	 ...
	 * @param editorGrid
     */
    public SegmentEntityScaleResponse(
        WorldModel model,
...
System.out.println("SegmentEntity.WALL_THICKNESS_PROP is a float now");	
				...
				if (anchorData == AnchorData.NORTH) {
					...
					MultiCommand multi =
						new MultiCommand(cmdList, "Change Wall Thickness");
